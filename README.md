...
- 記事ごとのいいね・コメント: `API Gateway HTTP API + Lambda + DynamoDB` を想定した連携 UI を搭載
...
- `src/components/ArticleEngagement.tsx`: 記事ごとのいいね・コメント UI
...
AWS 構成の雛形は [infra/aws/engagement-api/README.md](infra/aws/engagement-api/README.md) にあります。
