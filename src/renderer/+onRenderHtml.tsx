...
const onRenderHtml: OnRenderHtmlAsync = async (
  ...
  const meta = (pageContext.exports.meta ?? {}) as Record<
    string,
    { value: string }
  >;
    ...
    <html lang="ja">
      <head>
        ...
        <meta name="description" content="${
          description?.value || "映像とITの融合領域にチャレンジするプロジェクト"
        }" />
        
        {/* OGP & Twitter Card */}
        <meta property="og:title" content="${
          title?.value || "Himawari Project"
        }" />
        <meta property="og:description" content="${
          description?.value || "映像とITの融合領域にチャレンジするプロジェクト"
        }" />
        <meta property="og:image" content="${
          coverImage?.value || "https://at-himawari.com/avatar.png"
        }" />
